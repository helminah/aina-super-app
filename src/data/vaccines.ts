...
export const vaccines: Vaccine[] = [
  ...
  // ─── CDC USA SCHEDULE (source: cdc.gov/vaccines/schedules) ──────────────────
  { id:'us-hepb-1',    name:{fr:'Hépatite B (dose 1)',        en:'Hepatitis B (dose 1)'},       ageMonths:0,  ageLabel:AGE_BIRTH,      diseases:D_HEPB,   country:['united-states'] },
  { id:'us-rv-1',      name:{fr:'Rotavirus (dose 1)',         en:'Rotavirus (dose 1)'},          ageMonths:2,  ageLabel:ageMonths(2),   diseases:D_ROTA,   country:['united-states'] },
  { id:'us-dtap-1',    name:{fr:'DTaP (dose 1)',              en:'DTaP (dose 1)'},               ageMonths:2,  ageLabel:ageMonths(2),   diseases:{fr:'Diphtérie, Tétanos, Coqueluche', en:'Diphtheria, Tetanus, Pertussis', mg:'Difterie, Tetanôsy, Tsatsoka', wo:'Difteri, Tetanoos, Sëqët'}, country:['united-states'] },
  { id:'us-hib-1',     name:{fr:'Hib (dose 1)',               en:'Hib (dose 1)'},                ageMonths:2,  ageLabel:ageMonths(2),   diseases:{fr:'Haemophilus influenzae de type b', en:'Haemophilus influenzae type b', mg:'Haemophilus influenzae', wo:'Haemophilus influenzae'}, country:['united-states'] },
  { id:'us-pcv-1',     name:{fr:'Pneumocoque PCV15 (dose 1)', en:'PCV15 (dose 1)'},              ageMonths:2,  ageLabel:ageMonths(2),   diseases:D_PNEUMO, country:['united-states'] },
  { id:'us-ipv-1',     name:{fr:'Polio IPV (dose 1)',         en:'Polio IPV (dose 1)'},          ageMonths:2,  ageLabel:ageMonths(2),   diseases:D_POLIO,  country:['united-states'] },
  { id:'us-hepb-2',    name:{fr:'Hépatite B (dose 2)',        en:'Hepatitis B (dose 2)'},       ageMonths:2,  ageLabel:ageMonths(2),   diseases:D_HEPB,   country:['united-states'] },
  { id:'us-rv-2',      name:{fr:'Rotavirus (dose 2)',         en:'Rotavirus (dose 2)'},          ageMonths:4,  ageLabel:ageMonths(4),   diseases:D_ROTA,   country:['united-states'] },
  { id:'us-dtap-2',    name:{fr:'DTaP (dose 2)',              en:'DTaP (dose 2)'},               ageMonths:4,  ageLabel:ageMonths(4),   diseases:{fr:'Diphtérie, Tétanos, Coqueluche', en:'Diphtheria, Tetanus, Pertussis', mg:'Difterie, Tetanôsy, Tsatsoka', wo:'Difteri, Tetanoos, Sëqët'}, country:['united-states'] },
  { id:'us-hib-2',     name:{fr:'Hib (dose 2)',               en:'Hib (dose 2)'},                ageMonths:4,  ageLabel:ageMonths(4),   diseases:{fr:'Haemophilus influenzae de type b', en:'Haemophilus influenzae type b', mg:'Haemophilus influenzae', wo:'Haemophilus influenzae'}, country:['united-states'] },
  { id:'us-pcv-2',     name:{fr:'Pneumocoque PCV15 (dose 2)', en:'PCV15 (dose 2)'},              ageMonths:4,  ageLabel:ageMonths(4),   diseases:D_PNEUMO, country:['united-states'] },
  { id:'us-ipv-2',     name:{fr:'Polio IPV (dose 2)',         en:'Polio IPV (dose 2)'},          ageMonths:4,  ageLabel:ageMonths(4),   diseases:D_POLIO,  country:['united-states'] },
  { id:'us-dtap-3',    name:{fr:'DTaP (dose 3)',              en:'DTaP (dose 3)'},               ageMonths:6,  ageLabel:ageMonths(6),   diseases:{fr:'Diphtérie, Tétanos, Coqueluche', en:'Diphtheria, Tetanus, Pertussis', mg:'Difterie, Tetanôsy, Tsatsoka', wo:'Difteri, Tetanoos, Sëqët'}, country:['united-states'] },
  { id:'us-hib-3',     name:{fr:'Hib (dose 3)',               en:'Hib (dose 3)'},                ageMonths:6,  ageLabel:ageMonths(6),   diseases:{fr:'Haemophilus influenzae de type b', en:'Haemophilus influenzae type b', mg:'Haemophilus influenzae', wo:'Haemophilus influenzae'}, country:['united-states'] },
  { id:'us-pcv-3',     name:{fr:'Pneumocoque PCV15 (dose 3)', en:'PCV15 (dose 3)'},              ageMonths:6,  ageLabel:ageMonths(6),   diseases:D_PNEUMO, country:['united-states'] },
  { id:'us-ipv-3',     name:{fr:'Polio IPV (dose 3)',         en:'Polio IPV (dose 3)'},          ageMonths:6,  ageLabel:ageMonths(6),   diseases:D_POLIO,  country:['united-states'] },
  { id:'us-hepb-3',    name:{fr:'Hépatite B (dose 3)',        en:'Hepatitis B (dose 3)'},       ageMonths:6,  ageLabel:ageMonths(6),   diseases:D_HEPB,   country:['united-states'] },
  { id:'us-mmr-1',     name:{fr:'ROR/MMR (dose 1)',           en:'MMR (dose 1)'},                ageMonths:12, ageLabel:ageMonths(12),  diseases:D_ROR,    country:['united-states'] },
  { id:'us-varicella', name:{fr:'Varicelle (dose 1)',         en:'Varicella (dose 1)'},          ageMonths:12, ageLabel:ageMonths(12),  diseases:{fr:'Varicelle', en:'Chickenpox (Varicella)', mg:'Sakana', wo:'Sakana'}, country:['united-states'] },
  { id:'us-hepa-1',    name:{fr:'Hépatite A (dose 1)',        en:'Hepatitis A (dose 1)'},       ageMonths:12, ageLabel:ageMonths(12),  diseases:{fr:'Hépatite A', en:'Hepatitis A', mg:'Hepatite A', wo:'Hépatit A'}, country:['united-states'] },
  { id:'us-dtap-4',    name:{fr:'DTaP (dose 4)',              en:'DTaP (dose 4)'},               ageMonths:15, ageLabel:ageMonths(15),  diseases:{fr:'Diphtérie, Tétanos, Coqueluche', en:'Diphtheria, Tetanus, Pertussis', mg:'Difterie, Tetanôsy, Tsatsoka', wo:'Difteri, Tetanoos, Sëqët'}, country:['united-states'] },
  { id:'us-hepa-2',    name:{fr:'Hépatite A (dose 2)',        en:'Hepatitis A (dose 2)'},       ageMonths:18, ageLabel:ageMonths(18),  diseases:{fr:'Hépatite A', en:'Hepatitis A', mg:'Hepatite A', wo:'Hépatit A'}, country:['united-states'] },
  { id:'us-mmr-2',     name:{fr:'ROR/MMR (dose 2)',           en:'MMR (dose 2)'},                ageMonths:18, ageLabel:ageMonths(18),  diseases:D_ROR,    country:['united-states'] },
];
